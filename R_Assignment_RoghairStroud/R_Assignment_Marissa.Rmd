...
(Please excuse my oversight of spelling of Teosinte as "Teosinite" throughout the _entire_ document. I didn't realize it until I was finished coding, and I didn't want to go back and change it and risk breaking the code!)
...
setwd("./maize_files")
write.csv(maize_chr1, file = "maize_chr1.csv", row.names = FALSE)
write.csv(maize_chr2, file = "maize_chr2.csv", row.names = FALSE)
write.csv(maize_chr3, file = "maize_chr3.csv", row.names = FALSE)
write.csv(maize_chr4, file = "maize_chr4.csv", row.names = FALSE)
write.csv(maize_chr5, file = "maize_chr5.csv", row.names = FALSE)
write.csv(maize_chr6, file = "maize_chr6.csv", row.names = FALSE)
write.csv(maize_chr7, file = "maize_chr7.csv", row.names = FALSE)
write.csv(maize_chr8, file = "maize_chr8.csv", row.names = FALSE)
write.csv(maize_chr9, file = "maize_chr9.csv", row.names = FALSE)
write.csv(maize_chr10, file = "maize_chr10.csv", row.names = FALSE)

write.csv(maize_chr1_dec, file = "maize_chr1_dec.csv", row.names = FALSE)
write.csv(maize_chr2_dec, file = "maize_chr2_dec.csv", row.names = FALSE)
write.csv(maize_chr3_dec, file = "maize_chr3_dec.csv", row.names = FALSE)
write.csv(maize_chr4_dec, file = "maize_chr4_dec.csv", row.names = FALSE)
write.csv(maize_chr5_dec, file = "maize_chr5_dec.csv", row.names = FALSE)
write.csv(maize_chr6_dec, file = "maize_chr6_dec.csv", row.names = FALSE)
write.csv(maize_chr7_dec, file = "maize_chr7_dec.csv", row.names = FALSE)
write.csv(maize_chr8_dec, file = "maize_chr8_dec.csv", row.names = FALSE)
write.csv(maize_chr9_dec, file = "maize_chr9_dec.csv", row.names = FALSE)
write.csv(maize_chr10_dec, file = "maize_chr10_dec.csv", row.names = FALSE)


setwd("..")
dir.create("teosinte_files")
setwd("./teosinte_files")
write.csv(teosinite_chr1, file = "teosinite_chr1.csv", row.names = FALSE)
write.csv(teosinite_chr2, file = "teosinite_chr2.csv", row.names = FALSE)
write.csv(teosinite_chr3, file = "teosinite_chr3.csv", row.names = FALSE)
write.csv(teosinite_chr4, file = "teosinite_chr4.csv", row.names = FALSE)
write.csv(teosinite_chr5, file = "teosinite_chr5.csv", row.names = FALSE)
write.csv(teosinite_chr6, file = "teosinite_chr6.csv", row.names = FALSE)
write.csv(teosinite_chr7, file = "teosinite_chr7.csv", row.names = FALSE)
write.csv(teosinite_chr8, file = "teosinite_chr8.csv", row.names = FALSE)
write.csv(teosinite_chr9, file = "teosinite_chr9.csv", row.names = FALSE)
write.csv(teosinite_chr10, file = "teosinite_chr10.csv", row.names = FALSE)

write.csv(teosinite_chr1_dec, file = "teosinite_chr1_dec.csv", row.names = FALSE)
write.csv(teosinite_chr2_dec, file = "teosinite_chr2_dec.csv", row.names = FALSE)
write.csv(teosinite_chr3_dec, file = "teosinite_chr3_dec.csv", row.names = FALSE)
write.csv(teosinite_chr4_dec, file = "teosinite_chr4_dec.csv", row.names = FALSE)
write.csv(teosinite_chr5_dec, file = "teosinite_chr5_dec.csv", row.names = FALSE)
write.csv(teosinite_chr6_dec, file = "teosinite_chr6_dec.csv", row.names = FALSE)
write.csv(teosinite_chr7_dec, file = "teosinite_chr7_dec.csv", row.names = FALSE)
write.csv(teosinite_chr8_dec, file = "teosinite_chr8_dec.csv", row.names = FALSE)
write.csv(teosinite_chr9_dec, file = "teosinite_chr9_dec.csv", row.names = FALSE)
write.csv(teosinite_chr10_dec, file = "teosinite_chr10_dec.csv", row.names = FALSE)
...
```{r, echo = FALSE}
ggplot(data = maize_filtered_sorted) + 
  geom_point(mapping = aes(x=Chromosome, y=Position, color=Chromosome.Number), shape = '_', size = 10, alpha = 0.4) +
